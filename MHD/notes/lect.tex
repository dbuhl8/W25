...
\end{gather*}
Next we consider a specific flow field $\uvec$ called the Hartman flow given by
$\uvec = \left(u, 0, 0\right)$ and a specific magnetic field given by $\B = (0,
0, B_0\right)$. Let us investigate the dynamics that arise from this scenario.
...
\end{gather*}
where $M$ is the Hartman number given by $M = B_0/\sqrt{\mu\mu_0\eta}$ (measures
